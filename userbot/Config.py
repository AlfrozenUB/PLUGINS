...
if ENV:
    ...
    class Config(object):
        ...
        # emoji to be displayed  in help .royal
        ...
        ROYAL_STRING = os.environ.get("ROYAL_STRING", None)
        ...
        # number of rows of buttons to be displayed in .royal command
        ...
        # number of colums of buttons to be displayed in .royal command
