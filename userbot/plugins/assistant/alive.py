...
pm_caption += f"┣**License** ~ [License v3.0](github.com/ALfrozenUB/AlfrozenUB/blob/master/LICENSE)\n"
pm_caption += f"┣Copyright ~ By [『Alfrozen Usebrbot』 ](https://t.me/ErinaSupport)\n"
pm_caption += f"┣Owner ~ By [『AlfrozenX』 ](https://t.me/AlfrozenX)\n"
pm_caption += f"╰────────────\n"
