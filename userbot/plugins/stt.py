...
async def _(event):
    ...
    ROYALevent = await edit_or_reply(event, "Downloading to my local, for analysis  🙇")
    if event.reply_to_msg_id:
        ...
        if (
            ...
            await ROYALevent.edit("Starting analysis, using IBM WatSon Speech To Text")
            headers = {
            ...
            if "results" in r:
                ...
                await ROYALevent.edit(string_to_show)
            else:
                await ROYALevent.edit(r["error"])
