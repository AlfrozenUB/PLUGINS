...
pm_caption += f"┣ Owner  ~ [C R E A T O R ](https://t.me/MrElliotAlderson)\n"
pm_caption += f"┣ SUPPORT ~ [-G𝖗ουρ-](https://t.me/AnimeChatura)\n"
pm_caption += f"┣ REPO   ~ [-Rєρο-](https://github.com/KAjukatliii/AlfrozenUB)\n"
pm_caption += f"┣ Co-Owner ~ [GReninja](https://t.me/Greninja_369)\n"
pm_caption += f"┣ Helper ~ [ Rizoel ](https://t.me/TheRizoel/)\n"
pm_caption += f"**╰────────────**\n"
