...
async def _(event):
    ...
    process = await asyncio.create_subprocess_sROYAL(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [ROYALBOT](t.me/BR_guild) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
    "ls_local", None, "Gives the list of downloaded medias in your ROYALBOT server."
).add_command(
    "ls_root", None, "Gives the list of all files in root directory of ROYALBOT repo."
).add_command(
    "ls_saved",
    None,
    "Gives the list of all files in Saved directory of your ROYALBOT server",
).add_command(
