...
@ROYALBOT.on(admin_cmd(pattern=r"unpack", outgoing=True))
@ROYALBOT.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@ROYALBOT.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@ROYALBOT.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
