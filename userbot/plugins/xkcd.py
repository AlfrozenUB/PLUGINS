...
CmdHelp("xkcd").add_command(
    "xkcd", "<day in digit/without day>", "Give Detail Of That Day", "xkcd 19"
).add_info("It Can Help U To Find Information About That Day").add_warning(
    "Harmless Module"
).add_type(
    "Addons"
).add()
