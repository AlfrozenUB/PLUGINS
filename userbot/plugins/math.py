...
@ROYALBOT.on(admin_cmd(pattern="sin ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@ROYALBOT.on(admin_cmd(pattern="cos ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@ROYALBOT.on(admin_cmd(pattern="tan ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@ROYALBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@ROYALBOT.on(admin_cmd(pattern="sec ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@ROYALBOT.on(admin_cmd(pattern="cot ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@ROYALBOT.on(admin_cmd(pattern="square ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@ROYALBOT.on(admin_cmd(pattern="cube ?(.*)"))
@ROYALBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
